...
cmake -D "CMAKE_OSX_ARCHITECTURES:STRING=x86_64" -D"CMAKE_OSX_DEPLOYMENT_TARGET=10.10" -DWITH_CUPS=ON  -DCMAKE_BUILD_TYPE=Release -DWITH_FFMPEG=ON -DWITH_DSP_FFMPEG=ON -DWITH_FAAC=ON -DWITH_FAAD2=ON -DWITH_GFX_H264=ON -DBUILD_SHARED_LIBS=OFF -DMONOLITHIC_BUILD=ON
